...
class WriteScript:
    ...
    def write_script(self):
        ...
        self.write()
        self.writepy()
        self.writepy('import os')
        self.writepy('from pathlib import Path')
        self.writepy('import openseespy.opensees as ops')
        self.writepy('from ..subroutines.BeamHinge import BeamHinge')
        self.writepy('from ..subroutines.ColumnHinge import ColumnHinge')
        self.writepy('from ..subroutines.PanelZone import PanelZone')
        self.writepy('from ..subroutines.Spring_Zero import Spring_Zero')
        self.writepy('from ..subroutines.Spring_Rigid import Spring_Rigid')
        self.writepy('from ..subroutines.TimeHistorySolver import TimeHistorySolver')
        self.writepy('from ..subroutines.PushoverAnalysis import PushoverAnalysis')
        self.writepy('import time')
        self.writepy('from math import pi')
        self.writepy()
        self.writepy()
        self.write('wipe all;')
        ...
        self.writepy('StartTime = time.time()')
        self.write('set RunTime 0.0;')
        self.writepy('RunTime = 0.0')
        self.write('set EQ 1;  # $$$')
        self.writepy('EQ = 1')
        self.write('set PO 0;  # $$$')
        self.writepy('PO = 0')
        ...
        self.writepy('# Ground motion information')
        self.write('set MainFolder "H:/MRF_results/test/4SMRF";  # $$$')
        self.writepy('MainFolder = Path("H:/MRF_results/test/4SMRF")')
        line1 = self.Nlines
        self.write('set GMname "th5";  # $$$')
        self.writepy('GMname = "th5"')
        self.write('set SubFolder "th5";  # $$$')
        self.writepy('SubFolder = "th5"')
        self.write('set GMdt 0.01;  # $$$')
        self.writepy('GMdt = 0.01')
        self.write('set GMpoints 5590;  # $$$')
        self.writepy('GMpoints = 5590')
        self.write('set GMduration 55.89;  # $$$')
        self.writepy('GMduration = 55.89')
    ...
    def write_dynamic_analysis(self):
        ...
        self.writepy('    GMduration = GMdt * GMpoints')
        self.write('    set NumSteps [expr round(($GMduration + $FVduration)/$GMdt)];')
        self.writepy('    NumSteps = int((GMduration + FVduration) / GMdt)')
        ...
        self.writepy(f'    ctrl_nodes = {self.control_nodes}')
        self.writepy(f'    TimeHistorySolver(GMdt, totalTime, story_height, ctrl_nodes, 0.1, 0.5, GMname, 600)')
        self.write('')
        self.write('}')
        self.write('')
        self.write('')
