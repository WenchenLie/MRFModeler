...
def load_example(model: Literal['MRF4S_AS', 'MRF4S_AE', 'Benchmark_3S', 'Benchmark_9S']) -> Frame:
    ...
    """
    model_repository = ['MRF4S_AS', 'MRF4S_AE', 'Benchmark3S', 'Benchmark9S']
...
def _extract_model(model):
    ...
    with open(f'examples/{model}.pkl', 'rb') as f:
